      ...
      <main className="flex-1">
        ...
        <div className="bg-gradient-to-b from-primary/5 to-background py-16 text-center">
          ...
          <p className="mx-auto mt-3 max-w-lg text-muted-foreground text-pretty">
            Tingkatkan visibilitas properti Anda dan dapatkan fitur premium
            untuk mengelola kos dengan lebih mudah.
          </p>
          {isLoggedIn && currentUser?.role === "pemilik" && (
            <p className="mt-4 text-sm text-muted-foreground">
              Paket saat ini:{" "}
              <span className="font-semibold text-primary">
                {membershipLabel(currentTier)}
              </span>
            </p>
          )}
          {!isLoggedIn && (
              ...
              >
                ...
                {isPemilik ? (
                  <button
                    ...
                    disabled={
                      isCurrent || isDowngrade || upgrading === plan.tier
                    }
                    className={cn(
