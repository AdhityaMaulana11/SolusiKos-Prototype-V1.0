                  ...
                  {currentUser.membershipTier && (
                    <span
                      className={cn(
                        ...
                        currentUser.membershipTier === "emas"
                          ? "bg-amber-100 text-amber-700 dark:bg-amber-900/30 dark:text-amber-400"
                          : currentUser.membershipTier === "perak"
              ...
              <div className="flex flex-col gap-6">
                ...
                <div>
                  ...
                  <div className="flex flex-col gap-3">
                    {[
                      {
                        key: "email_payment" as const,
                        label: "Pembayaran",
                        desc: "Tagihan baru, konfirmasi pembayaran, pengingat jatuh tempo",
                      },
                      {
                        key: "email_booking" as const,
                        label: "Booking",
                        desc: "Booking baru, persetujuan, pembatalan",
                      },
                      {
                        key: "email_service" as const,
                        label: "Layanan",
                        desc: "Permintaan layanan, status layanan",
                      },
                    ].map((item) => (
                      <label
                        key={item.key}
              ...
              <div className="flex flex-col gap-3">
                <div className="flex items-center justify-between rounded-lg border border-border p-4">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Chrome - Windows 10 - Saat ini aktif
                    </p>
                  </div>
                ...
                <div className="flex items-center justify-between rounded-lg border border-border p-4">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Safari - iPhone 15 - Terakhir aktif 2 jam lalu
                    </p>
                  </div>
          ...
          <div className="w-full max-w-lg rounded-2xl border border-border bg-card shadow-xl">
            ...
            <div className="p-6">
              <div className="rounded-lg border border-border bg-background p-6">
                ...
                <p className="mt-2 text-sm text-muted-foreground">
                  Tagihan sewa bulan April 2026 sebesar{" "}
                  <strong className="text-foreground">Rp 1.575.000</strong>{" "}
                  telah dibuat. Jatuh tempo pembayaran adalah{" "}
                  <strong className="text-foreground">15 April 2026</strong>.
                </p>
